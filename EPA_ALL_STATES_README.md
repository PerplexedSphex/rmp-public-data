...
This will process all states and territories in alphabetical order.
...
- **Runtime**: The full data collection process may take several hours to complete, depending on the number of facilities and your internet connection.
- **Disk Space**: The complete dataset may require several gigabytes of disk space.
- **API Rate Limiting**: The script includes delays between requests to avoid overwhelming the EPA API.
