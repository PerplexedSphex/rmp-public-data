# CommerceCentre @ Buena Park, Bldg. C - Submission 24395
...
- **Parent Company**: Overton Moore Properties (OMP)

## Facility Identification

- **Facility Name**: CommerceCentre @ Buena Park, Bldg. C
- **DUNS Number**: None
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/24395)
