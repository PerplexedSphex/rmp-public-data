# Eversan Chester - Submission 1000119988
...
- **Facility ID**: 1000119988
- **Submission Type**: Resubmission
- **Receipt Date**: 2025-03-07
- **Parent Company**: Kin Properties as managing agent for Eversan, LLC

## Facility Identification

- **Facility Name**: Eversan Chester
- **DUNS Number**: None
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/1000119988)
