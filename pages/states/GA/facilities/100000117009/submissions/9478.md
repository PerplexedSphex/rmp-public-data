# Travis Field Water Quality Control Plant - Submission 9478
...
- **Facility Name**: Travis Field Water Quality Control Plant
- **DUNS Number**: None

## Location

- **Street Address**: 198 Darque Road
- **City**: Savannah
- **State**: GA
- **County**: CHATHAM
- **ZIP Code**: 31408
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/9478)
