# Naval Air Station (NAS) Pensacola - Submission 8214
...
- **Facility Name**: Naval Air Station (NAS) Pensacola
- **DUNS Number**: None

## Location

- **Street Address**: Building 3297 - WWTP, NAS Pensacola
- **City**: Pensacola
- **State**: FL
- **County**: ESCAMBIA
- **ZIP Code**: 32508-5217
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/8214)
