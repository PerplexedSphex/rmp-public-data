# Bee Ridge Water Reclamation Facility - Submission 1330
...
- **Facility Name**: Bee Ridge Water Reclamation Facility
- **DUNS Number**: None

## Location

- **Street Address**: 4001 Iona Rd.
- **City**: Sarasota
- **State**: FL
- **County**: SARASOTA
- **ZIP Code**: 34240
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/1330)
