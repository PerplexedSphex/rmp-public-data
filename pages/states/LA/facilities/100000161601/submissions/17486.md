# Kaplan Wastewater Treatment Plant - Submission 17486
...
- **Facility Name**: Kaplan Wastewater Treatment Plant
- **DUNS Number**: None

## Location

- **Street Address**: East Mire Street
- **City**: Kaplan
- **State**: LA
- **County**: VERMILION
- **ZIP Code**: 70548
...
- **self**: [Link](https://cdxapps.epa.gov/olem-rmp-pds/api/facilities/17486)
